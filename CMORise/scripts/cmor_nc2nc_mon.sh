        ...
        for ((nn=0;nn<num_fy;nn++)); do
			...
			if [ $mm -eq 11 ]; then
				...
				yynext=$yy
                        ...
                        case ${var_in[$var]} in
                            ...
                            clt | evspsbl | hfls | hfss | rsds | rlds | pr | prsn | prc)
                                file_in=$path_in$yy'/'${mm_s[$mm]}'/01/00/'$harm_name'_fp_'$domain_hclim'_'$exp_name'_mon_'$yy${mm_s[$mm]}'010000-'$yynext${mm_s[$mm+1]}'010000.nc';;
                        ...
                        if [ -f $file_in ]; then
                            ...
                            file_tmp=$path_tmp'tmp_'${var_in[$var]}'_'$domain_id'_'$driving_source_id'_'$experiment_id'_'$experiment_version'_'$source_id'_'$fy_out0$mp'-'$ly_out0$mp'.nc'

                            nccopy $file_in $file_tmp
                            day_to_set=16
                            if [[ ${mp} -eq 4 || ${mp} -eq 6 || ${mp} -eq 9 || ${mp} -eq 11 ]]; then
                                time_to_set='00:00:00'
                            elif [[ ${mp} -eq 1 || ${mp} -eq 3 || ${mp} -eq 5 || ${mp} -eq 7 || ${mp} -eq 8 || ${mp} -eq 10 || ${mp} -eq 12 ]]; then
                                time_to_set='12:00:00'
			    			elif [[ ${mp} -eq 2 ]]; then
								day_to_set=15
                                time_to_set='12:00:00'
                            fi
                            echo ' --- month day time to set :', ${mp}, $day_to_set, $time_to_set
                            ...
                            case ${var_in[$var]} in
                                ...
                                tsl)
				    				$cdo -L -monmean -setday,${day_to_set} -settime,${time_to_set} -selname,$harm_name,depth -seldate,$f_date,$l_date $file_in $file_tmp
                                    if [[ ${mp} -eq 4 || ${mp} -eq 6 || ${mp} -eq 9 || ${mp} -eq 11 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15; time_bnds(:, 1)=time+15;' $file_tmp $file_tmp
                                    elif [[ ${mp} -eq 1 || ${mp} -eq 3 || ${mp} -eq 5 || ${mp} -eq 7 || ${mp} -eq 8 || ${mp} -eq 10 || ${mp} -eq 12 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15.5; time_bnds(:, 1)=time+15.5;' $file_tmp $file_tmp
                                    elif [[ ${mp} -eq 2 ]]; then
                                        if [ "$( isleap $yy )" == "TRUE" ]; then
                                           ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-14.5; time_bnds(:, 1)=time+14.5;' $file_tmp $file_tmp
                                        else
                                           ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-14.5; time_bnds(:, 1)=time+13.5;' $file_tmp $file_tmp
                                        fi
				    				fi
                                    $cdo -L cat $file_tmp $file_tmp0;;
                                taspav | tasgree | tascan | hurscan | husscan | sfcWindcan)
				    				$cdo -L -monmean -setday,${day_to_set} -settime,${time_to_set} -selname,$harm_name,height -seldate,$f_date,$l_date $file_in $file_tmp
                                    if [[ ${mp} -eq 4 || ${mp} -eq 6 || ${mp} -eq 9 || ${mp} -eq 11 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15; time_bnds(:, 1)=time+15;' $file_tmp $file_tmp
                                    elif [[ ${mp} -eq 1 || ${mp} -eq 3 || ${mp} -eq 5 || ${mp} -eq 7 || ${mp} -eq 8 || ${mp} -eq 10 || ${mp} -eq 12 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15.5; time_bnds(:, 1)=time+15.5;' $file_tmp $file_tmp
                                    ...
                                    $cdo -L cat $file_tmp $file_tmp0;;
                               tasmax)
                                    $cdo -L -monmean -setday,${day_to_set} -settime,${time_to_set} -daymax -selname,$harm_name -seldate,$f_date,$l_date $file_in $file_tmp
                                    if [[ ${mp} -eq 4 || ${mp} -eq 6 || ${mp} -eq 9 || ${mp} -eq 11 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15; time_bnds(:, 1)=time+15;' $file_tmp $file_tmp
                                    elif [[ ${mp} -eq 1 || ${mp} -eq 3 || ${mp} -eq 5 || ${mp} -eq 7 || ${mp} -eq 8 || ${mp} -eq 10 || ${mp} -eq 12 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15.5; time_bnds(:, 1)=time+15.5;' $file_tmp $file_tmp
                                    ...
                                    $cdo -L cat $file_tmp $file_tmp0;;
                               tasmin)
                                    $cdo -L -monmean -setday,${day_to_set} -settime,${time_to_set} -daymin -selname,$harm_name -seldate,$f_date,$l_date $file_in $file_tmp
                                    if [[ ${mp} -eq 4 || ${mp} -eq 6 || ${mp} -eq 9 || ${mp} -eq 11 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15; time_bnds(:, 1)=time+15;' $file_tmp $file_tmp
                                    elif [[ ${mp} -eq 1 || ${mp} -eq 3 || ${mp} -eq 5 || ${mp} -eq 7 || ${mp} -eq 8 || ${mp} -eq 10 || ${mp} -eq 12 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15.5; time_bnds(:, 1)=time+15.5;' $file_tmp $file_tmp
                                    ...
                                    $cdo -L cat $file_tmp $file_tmp0;;
                                *)
 				    				$cdo -L -monmean -setday,${day_to_set} -settime,${time_to_set} -selname,$harm_name -seldate,$f_date,$l_date $file_in $file_tmp
                                    if [[ ${mp} -eq 4 || ${mp} -eq 6 || ${mp} -eq 9 || ${mp} -eq 11 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15; time_bnds(:, 1)=time+15;' $file_tmp $file_tmp
                                    elif [[ ${mp} -eq 1 || ${mp} -eq 3 || ${mp} -eq 5 || ${mp} -eq 7 || ${mp} -eq 8 || ${mp} -eq 10 || ${mp} -eq 12 ]]; then
                                        ncap2 -h -O -s 'time_bnds[$time, bnds]=0.; time_bnds(:, 0)=time-15.5; time_bnds(:, 1)=time+15.5;' $file_tmp $file_tmp
                ...
                if [ -f "$file_tmp0" ]; then
                    ...
                    f_y=`date -d $f_date +%Y`; f_m=`date -d $f_date +%m`
                    l_y=`date -d $l_date +%Y`; l_m=`date -d $l_date +%m`
                    f_date=${f_y}${f_m}; l_date=${l_y}${l_m}
